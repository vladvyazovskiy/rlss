...
num_epochs_before=3;
num_epochs_start=3;
num_epochs_during=3;%num_epochs_start and _during basically do the same (i.e. take epochs after onset so could have just done one variable)
...
x=4*(-num_epochs_before+1:1:num_epochs_start+num_epochs_during);%To express values in seconds given that they were pooled over 4-sec epochs
