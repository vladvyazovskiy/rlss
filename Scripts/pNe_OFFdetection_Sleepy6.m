...
path='/Users/mguillaumin/Documents/Post-doc Zurich/Sleepy6_OFFperiods/';
pathinPNE=[path]; %path for pNe files
...
%load pNe signal
filename='pNE_Oc_Qu_Ph_200318_L';%[mousename,'-pNe-',BLdate,'-ch',chan];
load([pathinPNE filename '.mat']);

%transform
sig=double(pNe2_extract.data(4,:))/1000000; %transform into uV values
...
filenameVS=[mousename,'_',BLdate,'_fro','_VSspec'];
