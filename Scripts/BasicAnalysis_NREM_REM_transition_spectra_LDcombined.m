...
Average_Spec_WT=zeros(81,30,5); Average_Spec_HOM=zeros(81,30,5);
%WT animals
figure(1)
for n=1:5
...
%             [SE_W,EpDur_W]=DetectEpisodes(wake,10800,mindur_W,ba);
            ...
            Average_Spec=mean(Selec_Spec,3);
            figure(3)
            subplot(2,5,n)
            surf(x_ticks, freq,Average_Spec)%pcolor(x_ticks,freq,Average_Spec)
