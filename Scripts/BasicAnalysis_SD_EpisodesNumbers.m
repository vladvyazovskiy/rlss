...
%             W_L=w; NR_L=nr; R_L=r; W1_L=w1; NR2_L=nr2; R3_L=r3; MT_L=mt; Spectr_L=spectr;
            ...
            nrem=zeros(1,10800);nrem(nr(nr>5400))=1;nrem(nr2(nr2>5400))=1;
            rem=zeros(1,10800);rem(r(r>5400))=1;rem(r3(r3>5400))=1;
            baw=zeros(1,10800);baw(mt(mt>5400))=1;
...
ylabel('Episode duration (min)');
set(gca,'XTickLabel',{'WT','HOM'});
title('NR episodes - 6h after SD (light)');