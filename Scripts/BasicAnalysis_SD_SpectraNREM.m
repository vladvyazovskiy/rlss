...
ylim([0 300])
ylabel('NREMS relative spectra (% of baseline mean)');
xlabel('Frequency (Hz)');
...
grid on
legend('ZT6-8','ZT8-10','ZT10-12')%,'ZT12-14')
title('HOM - Spectra in NREM following SD (normalised against BL)');
ylim([0 300])
ylabel('NREMS relative spectra (% of baseline mean)');
xlabel('Frequency (Hz)');
...
title('Spectra in NREM in 2h following SD (normalised against BL)');
ylim([0 250])
