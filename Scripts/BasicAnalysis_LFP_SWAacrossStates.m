...
%spectra
WT_NR=zeros(n_WT,21600);WT_R=zeros(n_WT,21600);WT_W=zeros(n_WT,21600);WT_swa=zeros(n_WT,21600);
HOM_NR=zeros(n_HOM,21600);HOM_R=zeros(n_HOM,21600);HOM_W=zeros(n_HOM,21600);HOM_swa=zeros(n_HOM,21600);
