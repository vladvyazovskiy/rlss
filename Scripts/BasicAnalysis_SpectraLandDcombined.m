...
if strcmp(der,'fro')
    figure(1)
    hold on
    h=plot(f,Pval_Fro_NREM,'k','LineWidth',2);
    for l=1:length(h)
    ...
    figure(2)
    hold on
    h=plot(f,Pval_Fro_REM,'k','LineWidth',2);
    for l=1:length(h)
        h(l).Annotation.LegendInformation.IconDisplayStyle = 'off';
    end
    xlim([0 20]);
    ...
    figure(3)
    hold on
    h=plot(f,Pval_Fro_Wake,'k','LineWidth',2);
    for l=1:length(h)
        h(l).Annotation.LegendInformation.IconDisplayStyle = 'off';
    end
    xlim([0 20]);
...
elseif strcmp(der,'occ')
    figure(1)
    hold on
    h=plot(f,Pval_Occ_NREM,'k','LineWidth',2);
    for l=1:length(h)
        h(l).Annotation.LegendInformation.IconDisplayStyle = 'off';
    end
    xlim([0 20]);
    ...
    figure(2)
    hold on
    h=plot(f,Pval_Occ_REM,'k','LineWidth',2);
    for l=1:length(h)
        h(l).Annotation.LegendInformation.IconDisplayStyle = 'off';
    end
    xlim([0 20]);
    ...
    figure(3)
    hold on
    h=plot(f,Pval_Occ_Wake,'k','LineWidth',2);
    for l=1:length(h)
        h(l).Annotation.LegendInformation.IconDisplayStyle = 'off';
    end
    xlim([0 20]);
